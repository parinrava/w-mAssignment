...
function create_db()
{
    ...
    $categories = [
        'Miscellaneous' => ['O.D.P'],
        'CellphoneService' => ['ROGERS', 'Shaw'],
        'Donations' => ['RED CROSS', 'World Vision'],
        'Insurance' => ['ICBC'],
        'Groceries' => ['REAL CDN SUPERS', 'SAFEWAY', 'Walmart', 'Costco', 'CANADIAN TIRE', '7-eleven'],
        'Utilities' => ['FORTISBC'],
        'Entertainment' => ['St James res', 'Pur & Simple res', 'Subway', 'Mcdonalds', 'White spot', 'Tim hortons'] ];
